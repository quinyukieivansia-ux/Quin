...
$judul = explode('/genres/', $actual_link);
// echo $judul[1];
$content = file_get_contents($sumber_data.'/genres/'.$judul[1]);
...
$result = str_replace('Download', 'Download / Play', $result);
...
<body>
    ...
    <div class="container" style="margin-bottom: 50px;">
        <section class="col-md-12">
            ...
            <H2 style='margin-top: 50px; text-transform: uppercase;'>GENRE : <?php echo str_replace('/', '', $judul[1]); ?></H2>
            <?php echo $complete; ?>
        </section>
