...
$judul = explode('/episode/', $actual_link);
// echo $judul[1];
...
$result = str_replace($sumber_data.'/lengkap', $domain.'/lengkap', $result);
$result = str_replace($sumber_data.'/batch', $domain.'/batch', $result);
$result = str_replace($sumber_data.'/genres', $domain.'/genres', $result);
$result = str_replace('<span>', '<p>', $result);
$result = str_replace('</span>', '</p>', $result);
